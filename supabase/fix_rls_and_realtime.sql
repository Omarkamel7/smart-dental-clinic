...
-- 2. Clean up and recreate Profiles Policies (Public Read & Write)
...
-- 3. Clean up and recreate Consultations Policies (Public Read & Write)
...
-- 4. Clean up and recreate Messages Policies (Public Read & Write for seamless real-time messaging)
